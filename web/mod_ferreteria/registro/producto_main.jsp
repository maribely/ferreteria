...
<head>
    ...
    function listar(){
      document.bus_fm.action='producto_list.jsp';
...
<body  onload='sf()'>
  <table align="center">
	<form action='producto_main.jsp' method='post' name='bus_fm'>
	<tr><td>
    ...
    <tr><td>
		<%
		 ...
		 if( !go.equals("")) {
		%>
		<jsp:include page="producto_result.jsp" flush="false" />
		<% }  else out.print("<br><b>AYUDA:</b> <br>"+
		              "<li>Haga clic en el bot&oacute;n Buscar para agregar nuevo producto o editar datos del producto o para eliminarlo</li>"+
		              "<li>Haga clic en el bot&oacute;n Listar para obtener el reporte de producto</li>");
		%> 				
    </td></tr>
  </table>
</body>
