...
<%	
		do{
			...
			out.print(" > ");	out.print( p.getNombre()+" :"+p.getDni() +""); out.print("</option>");
...
<% if(i>0) out.print("document.res_fm.cliente_id.onkeyup = enter;");
%>
  function sf(){ 
<% if(i>0) out.print("document.res_fm.cliente_id.focus();");
%>  	 
  }
// --></script>
