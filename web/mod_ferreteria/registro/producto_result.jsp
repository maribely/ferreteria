...
%>
  <table border='0' cellspacing='2' cellpadding='1' align='center'>
    <tr><th>Elegir</th></tr>
    <form action='producto_fm.jsp' method='post' name='res_fm'>
        <input type='hidden' name='go' value='Editar'>
    <tr><td align='center'>
        <select name='id_producto' size='10'>
<%	
		do{
			i++;
			...
			out.print(" > ");	out.print( p.getDescripcion()+" :"+p.getPrecio() +":"+p.getStok()+":"); out.print("</option>");
...
<form action='producto_fm.jsp' method='post' name='res_fm2'>
...
<% if(i>0) out.print("document.res_fm.id_producto.onkeyup = enter;");
%>
  function sf(){ 
<% if(i>0) out.print("document.res_fm.id_producto.focus();");
%>  	 
  }
// --></script>
