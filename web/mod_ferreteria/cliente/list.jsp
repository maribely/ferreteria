...
<html>
    ...
    <body class="c-container">
        <div class="center">
            <h2 class="text-warm">Reporte de clientes</h2>
        ...
        <div class="c-form-container">
            <table border='0' id="articulo"  cellspacing='2' cellpadding='1' align="center" >
                ...
                <tr>
                    <th># </th><th>Nombres</th><th>Apellidos</th> <th>DNI</th><th>RUC</th><th>Género</th><th>Email</th><th>Telefono</th><th>Dirección</th>
                </tr>
                <%  int i = 0;
                    try {
