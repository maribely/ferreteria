    ...
    <body class="c-container-short">
        ...
        <div class="c-form-container">
            <form action='save.jsp' name='fm' method='post' onsubmit='return enviar()'>
                ...
                <input type='text' class='c-field' name='razon_social' placeholder="Ingrese razon social" value='<%=d.getRazon_social()%>'>
                <label>RUC *</label> 
                <input type='text' class='c-field' name='ruc' placeholder="Ingrese ruc" value='<%=d.getRuc()%>'>
                <label>Dirección *</label> 
                <input type='text' class='c-field' name='direccion' placeholder="Ingrese dirección" value='<%=d.getDireccion()%>'>
