...
<head>
    ...
    function listar(){
      document.bus_fm.action='proveedor_list.jsp';
...
<body  onload='sf()'>
  <table align="center">
	<form action='proveedor_main.jsp' method='post' name='bus_fm'>
	<tr><td>
    ...
    <tr><td>
		<%
		 ...
		 if( !go.equals("")) {
		%>
		<jsp:include page="proveedor_result.jsp" flush="false" />
		<% }  else out.print("<br><b>AYUDA:</b> <br>"+
		              "<li>Haga clic en el bot&oacute;n Buscar para agregar nuevo persona o editar datos del persona o para eliminarlo</li>"+
